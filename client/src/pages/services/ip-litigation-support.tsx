...
export default function IPLitigationSupport() {
  ...
  const features = [
    {
      ...
      description: "Expert legal representation in IP litigation cases."
    },
    {
      icon: Shield,
      title: "Infringement Defense",
      description: "Defend against IP infringement allegations."
    },
    {
      icon: TrendingUp,
      title: "Enforcement Actions",
      description: "Take enforcement actions against infringers."
    },
    {
      icon: AlertTriangle,
      title: "Settlement Negotiation",
      description: "Negotiate favorable settlements and agreements."
    }
  ];
  ...
  const process = [
    {
      step: "01",
      title: "Case Analysis",
      description: "Analyze IP litigation case details"
    },
    {
      step: "02",
      title: "Strategy Development",
      description: "Develop litigation strategy"
    },
    {
      step: "03",
      title: "Legal Proceedings",
      description: "Handle legal proceedings"
    },
    {
      step: "04",
      title: "Resolution",
      description: "Achieve favorable resolution"
    }
  ];
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-white/90 mb-8 leading-relaxed">
                Expert IP litigation support to protect your intellectual property rights. Get comprehensive legal representation and enforcement services for IP disputes.
              </p>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-900 mb-4">Why Choose IP Litigation Support?</h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Professional IP litigation support services to protect your intellectual property rights effectively.
            </p>
          </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Our systematic approach ensures effective IP litigation support and resolution.
            </p>
          </div>
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <Card className="shadow-xl border-2 border-[#F7941D]">
              <CardContent className="p-8">
                <div className="text-center mb-8">
                  <h3 className="text-3xl font-bold text-gray-900 mb-4">Complete IP Litigation Support Package</h3>
                  <div className="text-4xl font-bold text-[#F7941D] mb-2">₹95,999</div>
                  <p className="text-gray-600">One-time litigation support service, no hidden charges</p>
                </div>
                <div className="grid md:grid-cols-2 gap-8">
                  <div>
                    ...
                    <ul className="space-y-2">
                      ...
                      <li className="flex items-center">
                        <Check className="text-green-500 w-4 h-4 mr-2" />
                        <span className="text-gray-700">Court proceedings</span>
                      </li>
                      <li className="flex items-center">
                        <Check className="text-green-500 w-4 h-4 mr-2" />
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Contact our experts today and protect your intellectual property rights effectively.
            </p>
          </div>

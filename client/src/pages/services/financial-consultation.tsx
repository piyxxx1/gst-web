...
export default function FinancialConsultation() {
  ...
  const features = [
    ...
    },
    {
      ...
      description: "Identify and manage financial risks effectively."
    },
    {
      icon: AlertTriangle,
      title: "Tax Optimization",
      description: "Optimize tax strategies for maximum savings."
    }
  ];
  ...
  const process = [
    ...
    },
    {
      step: "02",
      title: "Planning",
      description: "Develop financial strategies"
    },
    {
      step: "03",
      title: "Implementation",
      description: "Implement financial plans"
    },
    {
      step: "04",
      title: "Monitoring",
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-white/90 mb-8 leading-relaxed">
                Expert financial consultation services to optimize your business finances and investments. Get professional financial planning and strategic advice for sustainable growth.
              </p>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-900 mb-4">Why Choose Financial Consultation?</h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Professional financial consultation services to optimize your business finances and investments.
            </p>
          </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Our systematic approach ensures comprehensive financial consultation and optimization.
            </p>
          </div>
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <Card className="shadow-xl border-2 border-[#F7941D]">
              <CardContent className="p-8">
                <div className="text-center mb-8">
                  <h3 className="text-3xl font-bold text-gray-900 mb-4">Complete Financial Consultation Package</h3>
                  <div className="text-4xl font-bold text-[#F7941D] mb-2">₹12,999/month</div>
                  <p className="text-gray-600">Monthly financial consultation service, no hidden charges</p>
                </div>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Contact our financial experts today and optimize your business finances.
            </p>
          </div>

  ...
  const features = [
    {
      ...
      description: "Expert legal advice on business and corporate matters."
    },
    {
      icon: Shield,
      title: "Contract Review",
      description: "Comprehensive contract review and drafting services."
    },
    {
      icon: TrendingUp,
      title: "Risk Assessment",
      description: "Identify and mitigate legal risks in your business."
    },
    {
      icon: AlertTriangle,
      title: "Dispute Resolution",
      description: "Professional dispute resolution and mediation services."
    }
  ];
  ...
  const process = [
    {
      ...
      description: "Discuss your legal needs and requirements"
    },
    {
      step: "02",
      title: "Analysis",
      description: "Analyze legal issues and provide solutions"
    },
    {
      step: "03",
      title: "Implementation",
      description: "Implement legal strategies and solutions"
    },
    {
      step: "04",
      title: "Ongoing Support",
      description: "Provide continuous legal support and guidance"
    }
  ];
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-white/90 mb-8 leading-relaxed">
                Expert legal consultation services to guide your business decisions and ensure compliance. Get professional legal advice and strategic planning for your business needs.
              </p>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-900 mb-4">Why Choose Legal Consultation?</h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Professional legal consultation services to protect your business interests and ensure compliance.
            </p>
          </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Our systematic approach ensures comprehensive legal consultation and support.
            </p>
          </div>
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <Card className="shadow-xl border-2 border-[#F7941D]">
              <CardContent className="p-8">
                <div className="text-center mb-8">
                  <h3 className="text-3xl font-bold text-gray-900 mb-4">Complete Legal Consultation Package</h3>
                  <div className="text-4xl font-bold text-[#F7941D] mb-2">₹15,999/month</div>
                  <p className="text-gray-600">Monthly legal consultation service, no hidden charges</p>
                </div>
                <div className="grid md:grid-cols-2 gap-8">
                  <div>
                    ...
                    <ul className="space-y-2">
                      ...
                      <li className="flex items-center">
                        <Check className="text-green-500 w-4 h-4 mr-2" />
                        <span className="text-gray-700">Contract review</span>
                      </li>
                      <li className="flex items-center">
                        <Check className="text-green-500 w-4 h-4 mr-2" />
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Contact our legal experts today and get professional guidance for your business.
            </p>
          </div>

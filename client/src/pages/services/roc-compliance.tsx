...
import { Check, Clock, Shield, FileText, Phone, Mail, MapPin, Users, Award, AlertTriangle } from "lucide-react";
...
export default function ROCCompliance() {
  ...
  const features = [
    ...
    },
    {
      ...
      description: "Timely filing of all required documents and returns."
    },
    {
      icon: AlertTriangle,
    ...
    },
    {
      icon: Award,
      title: "Good Standing",
      description: "Maintain good standing with regulatory authorities."
    }
  ];
  ...
  const process = [
    {
      ...
      description: "Review current compliance status and requirements"
    },
    {
      step: "02",
    ...
    },
    {
      step: "03",
      title: "Timely Filing",
      description: "File all returns and documents on time"
    },
    {
      step: "04",
      title: "Monitoring",
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-white/90 mb-8 leading-relaxed">
                Ensure your company meets all regulatory requirements and deadlines. Stay compliant and avoid penalties with our expert services.
              </p>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-900 mb-4">Why Choose ROC Compliance?</h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Stay compliant and avoid penalties with our comprehensive ROC compliance services.
            </p>
          </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Our streamlined process ensures timely and accurate compliance management.
            </p>
          </div>
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <Card className="shadow-xl border-2 border-[#F7941D]">
              <CardContent className="p-8">
                <div className="text-center mb-8">
                  <h3 className="text-3xl font-bold text-gray-900 mb-4">Complete ROC Compliance Package</h3>
                  <div className="text-4xl font-bold text-[#F7941D] mb-2">₹8,999/year</div>
                  <p className="text-gray-600">Annual compliance management, no hidden charges</p>
                </div>
                  ...
                  <div>
                    ...
                    <ul className="space-y-2">
                      <li className="flex items-center">
                        ...
                        <span className="text-gray-700">Annual return filing</span>
                      </li>
                      <li className="flex items-center">
                        <Check className="text-green-500 w-4 h-4 mr-2" />
                        <span className="text-gray-700">Financial statement filing</span>
                      </li>
                      <li className="flex items-center">
                        <Check className="text-green-500 w-4 h-4 mr-2" />
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Contact our experts today and ensure your company stays compliant.
            </p>
          </div>

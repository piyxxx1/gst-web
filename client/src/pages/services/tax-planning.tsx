...
import { Check, Clock, Shield, FileText, Phone, Mail, MapPin, Users, Award, Calculator, TrendingUp, PiggyBank } from "lucide-react";
  ...
  const features = [
    {
      ...
      description: "Comprehensive tax planning strategies to minimize liabilities."
    },
    {
      icon: TrendingUp,
      title: "Tax Optimization",
      description: "Optimize your tax position through legal deductions and exemptions."
    },
    {
      icon: PiggyBank,
      title: "Savings Maximization",
      description: "Maximize your savings through effective tax planning."
    },
    {
      icon: Shield,
      title: "Compliance Assurance",
      description: "Ensure full compliance while optimizing tax benefits."
    }
  ];
  ...
  const process = [
    {
      ...
      description: "Analyze current financial position and tax structure"
    },
    {
      step: "02",
    ...
    },
    {
      ...
      description: "Implement tax-saving measures and investments"
    },
    {
      step: "04",
      title: "Monitoring",
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-white/90 mb-8 leading-relaxed">
                Optimize your tax position and maximize savings with our comprehensive tax planning services. Strategic planning for better financial outcomes.
              </p>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-900 mb-4">Why Choose Tax Planning?</h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Strategic tax planning to minimize liabilities and maximize your savings through legal optimization.
            </p>
          </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Our comprehensive approach ensures optimal tax planning and maximum savings.
            </p>
          </div>
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <Card className="shadow-xl border-2 border-[#F7941D]">
              <CardContent className="p-8">
                <div className="text-center mb-8">
                  <h3 className="text-3xl font-bold text-gray-900 mb-4">Complete Tax Planning Package</h3>
                  <div className="text-4xl font-bold text-[#F7941D] mb-2">₹12,999/year</div>
                  <p className="text-gray-600">Annual tax planning service, no hidden charges</p>
                </div>
                <div className="grid md:grid-cols-2 gap-8">
                  <div>
                    ...
                    <ul className="space-y-2">
                      ...
                      <li className="flex items-center">
                        <Check className="text-green-500 w-4 h-4 mr-2" />
                        <span className="text-gray-700">Tax strategy development</span>
                      </li>
                      <li className="flex items-center">
                        <Check className="text-green-500 w-4 h-4 mr-2" />
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Contact our experts today and optimize your tax position for maximum savings.
            </p>
          </div>

...
import { Check, Clock, Shield, FileText, Phone, Mail, MapPin, Users, Award, Calculator, TrendingUp, AlertTriangle } from "lucide-react";
  ...
  const features = [
    {
      ...
      description: "Comprehensive transfer pricing analysis and documentation."
    },
    {
      icon: Shield,
      title: "Compliance Assurance",
      description: "Ensure compliance with transfer pricing regulations."
    },
    {
      icon: TrendingUp,
      title: "Risk Management",
      description: "Identify and mitigate transfer pricing risks."
    },
    {
      icon: AlertTriangle,
      title: "Audit Support",
      description: "Support during transfer pricing audits and assessments."
    }
  ];
  ...
  const process = [
    {
      step: "01",
      title: "Assessment",
      description: "Assess related party transactions"
    },
    {
      step: "02",
      title: "Analysis",
      description: "Conduct pricing analysis"
    },
    {
      step: "03",
      title: "Documentation",
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-white/90 mb-8 leading-relaxed">
                Expert transfer pricing services to ensure compliance with regulations and optimize your intercompany transactions. Get comprehensive analysis and documentation support.
              </p>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-900 mb-4">Why Choose Transfer Pricing?</h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Professional transfer pricing services to ensure compliance and optimize your intercompany transactions.
            </p>
          </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Our systematic approach ensures comprehensive transfer pricing compliance and optimization.
            </p>
          </div>
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <Card className="shadow-xl border-2 border-[#F7941D]">
              <CardContent className="p-8">
                <div className="text-center mb-8">
                  <h3 className="text-3xl font-bold text-gray-900 mb-4">Complete Transfer Pricing Package</h3>
                  <div className="text-4xl font-bold text-[#F7941D] mb-2">₹65,999/year</div>
                  <p className="text-gray-600">Annual transfer pricing service, no hidden charges</p>
                </div>
                  ...
                  <div>
                    ...
                    <ul className="space-y-2">
                      <li className="flex items-center">
                        ...
                        <span className="text-gray-700">Pricing analysis</span>
                      </li>
                      <li className="flex items-center">
                        <Check className="text-green-500 w-4 h-4 mr-2" />
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Contact our experts today and ensure transfer pricing compliance for your business.
            </p>
          </div>

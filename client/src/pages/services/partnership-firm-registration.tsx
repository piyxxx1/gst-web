...
import { Check, Clock, Shield, Users, FileText, Phone, Mail, MapPin } from "lucide-react";
...
export default function PartnershipFirmRegistration() {
  ...
  const features = [
    {
      ...
      description: "Get legal recognition and protection for your partnership business."
    },
    {
      icon: Users,
      title: "Multiple Partners",
      description: "Register with 2 or more partners with shared responsibilities."
    },
    {
      icon: FileText,
      title: "Easy Documentation",
      description: "Simplified documentation process with expert guidance."
    },
    {
      icon: Clock,
      title: "Quick Registration",
      description: "Complete registration process in just 7-10 working days."
    }
  ];
  ...
  const process = [
    ...
    },
    {
      ...
      description: "File partnership registration application"
    },
    {
      step: "03",
      title: "Verification",
      description: "Government verification and approval process"
    },
    {
      step: "04",
      title: "Certificate Issuance",
      description: "Receive partnership registration certificate"
    }
  ];
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-white/90 mb-8 leading-relaxed">
                Register your partnership firm with legal recognition and protection. Get expert guidance for a smooth registration process.
              </p>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-900 mb-4">Why Choose Partnership Registration?</h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Get legal recognition and protection for your partnership business with our expert services.
            </p>
          </div>
            ...
            <Card className="shadow-xl border-2 border-[#F7941D]">
              <CardContent className="p-8">
                <div className="text-center mb-8">
                  <h3 className="text-3xl font-bold text-gray-900 mb-4">Complete Partnership Registration Package</h3>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Contact our experts today and get your partnership firm registered quickly and efficiently.
            </p>
          </div>

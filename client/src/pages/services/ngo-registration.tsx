...
import { Check, Clock, Shield, Heart, FileText, Phone, Mail, MapPin, Users, Award } from "lucide-react";
...
export default function NGORegistration() {
  ...
  const features = [
    {
      icon: Heart,
      title: "Social Impact",
      description: "Create positive social change with legal recognition."
    },
    {
      icon: Shield,
      title: "Legal Protection",
      description: "Get legal protection and credibility for your NGO."
    },
    {
      icon: Users,
      title: "Team Structure",
      description: "Establish proper governance and team structure."
    },
    {
      icon: Award,
      title: "Tax Benefits",
      description: "Enjoy tax exemptions and benefits for donations."
    }
  ];
  ...
  const process = [
    ...
    },
    {
      ...
      description: "File NGO registration application"
    },
    {
      step: "03",
    ...
    },
    {
      ...
      description: "Receive NGO registration certificate"
    }
  ];
  ...
  const benefits = [
    ...
    "Better credibility with donors",
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-white/90 mb-8 leading-relaxed">
                Turn your vision into action with expert NGO registration support. Get legal recognition and start making a difference.
              </p>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-900 mb-4">Why Choose NGO Registration?</h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Get legal recognition and protection for your social cause with our expert services.
            </p>
          </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Our streamlined process ensures quick and hassle-free NGO registration.
            </p>
          </div>
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <Card className="shadow-xl border-2 border-[#F7941D]">
              <CardContent className="p-8">
                <div className="text-center mb-8">
                  <h3 className="text-3xl font-bold text-gray-900 mb-4">Complete NGO Registration Package</h3>
                  <div className="text-4xl font-bold text-[#F7941D] mb-2">₹4,999</div>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Contact our experts today and get your NGO registered quickly and efficiently.
            </p>
          </div>

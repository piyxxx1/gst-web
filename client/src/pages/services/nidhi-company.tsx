...
export default function NidhiCompany() {
  ...
  const features = [
    {
      icon: Users,
      title: "Member-Based Structure",
      description: "Operate as a mutual benefit society for members."
    },
    {
      icon: Shield,
      title: "Regulated Operations",
      description: "Comply with RBI and Companies Act regulations."
    },
    {
      icon: Calculator,
      title: "Deposit & Lending",
      description: "Accept deposits and provide loans to members."
    },
    {
      icon: Lock,
      title: "Secure Framework",
      description: "Robust regulatory framework for financial operations."
    }
  ];
  ...
  const process = [
    {
      ...
      description: "Register as a public limited company"
    },
    {
      step: "02",
      title: "RBI Application",
      description: "Apply for Nidhi company recognition"
    },
    {
      step: "03",
      title: "Compliance Setup",
      description: "Establish regulatory compliance systems"
    },
    {
      step: "04",
      title: "Operations Start",
      description: "Begin deposit and lending activities"
    }
  ];
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-white/90 mb-8 leading-relaxed">
                Establish a mutual benefit society for your community. Get expert guidance for Nidhi company registration and regulatory compliance.
              </p>
            ...
            <div>
              <Card className="shadow-xl">
                <CardHeader className="text-center bg-green-600 text-white rounded-t-lg">
                  <CardTitle className="text-2xl">Nidhi Company Package</CardTitle>
                  <div className="text-4xl font-bold mt-2">₹8,999</div>
                  <p className="text-green-100">Complete Nidhi solution</p>
                </CardHeader>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-900 mb-4">Why Choose Nidhi Company?</h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              A regulated mutual benefit society structure for community-based financial services.
            </p>
          </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Our streamlined process ensures quick and compliant Nidhi company registration.
            </p>
          </div>
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">

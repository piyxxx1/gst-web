...
import { Check, Clock, Shield, FileText, Phone, Mail, MapPin, Users, Award, Scale, AlertTriangle, TrendingUp } from "lucide-react";
  ...
  const features = [
    {
      ...
      description: "Ensure compliance with all applicable laws and regulations."
    },
    {
      icon: Shield,
      title: "Risk Mitigation",
      description: "Identify and mitigate legal risks proactively."
    },
    {
      icon: TrendingUp,
      title: "Business Protection",
      description: "Protect your business from legal complications."
    },
    {
      icon: AlertTriangle,
      title: "Audit Support",
      description: "Support during regulatory audits and inspections."
    }
  ];
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-white/90 mb-8 leading-relaxed">
                Ensure your business stays compliant with all applicable laws and regulations. Mitigate risks and protect your business with expert legal compliance services.
              </p>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-900 mb-4">Why Choose Legal Compliance?</h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Comprehensive legal compliance services to protect your business and ensure regulatory adherence.
            </p>
          </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Our comprehensive approach ensures complete legal compliance for your business.
            </p>
          </div>
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <Card className="shadow-xl border-2 border-[#F7941D]">
              <CardContent className="p-8">
                <div className="text-center mb-8">
                  <h3 className="text-3xl font-bold text-gray-900 mb-4">Complete Legal Compliance Package</h3>
                  <div className="text-4xl font-bold text-[#F7941D] mb-2">₹15,999/year</div>
                  <p className="text-gray-600">Annual compliance service, no hidden charges</p>
                </div>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Contact our experts today and ensure complete legal compliance for your business.
            </p>
          </div>

...
import { Check, Clock, Shield, User, FileText, Phone, Mail, MapPin, TrendingUp, Zap } from "lucide-react";
  ...
  const features = [
    {
      ...
      description: "Complete control and ownership of your business."
    },
    {
      icon: Zap,
      title: "Quick Setup",
      description: "Fastest way to start your business legally."
    },
    {
      icon: TrendingUp,
      title: "Easy Management",
      description: "Simplified business structure and operations."
    },
    {
      icon: Shield,
      title: "Legal Recognition",
      description: "Get legal recognition for your business activities."
    }
  ];
  ...
  const process = [
    {
      ...
      description: "Collect required identity and address proofs"
    },
    {
      step: "02",
      title: "Application Filing",
      description: "File sole proprietorship registration"
    },
    {
      step: "03",
      title: "Verification",
    ...
    },
    {
      ...
      description: "Receive business registration certificate"
    }
  ];
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-white/90 mb-8 leading-relaxed">
                Start your business journey with complete control. Get legal recognition for your sole proprietorship with our expert guidance.
              </p>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-900 mb-4">Why Choose Sole Proprietorship?</h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              The simplest and fastest way to start your business with complete control and minimal complexity.
            </p>
          </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Our streamlined process ensures quick and hassle-free sole proprietorship registration.
            </p>
          </div>
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <Card className="shadow-xl border-2 border-[#F7941D]">
              <CardContent className="p-8">
                <div className="text-center mb-8">
                  <h3 className="text-3xl font-bold text-gray-900 mb-4">Complete Sole Proprietorship Package</h3>
                  <div className="text-4xl font-bold text-[#F7941D] mb-2">₹1,999</div>
                ...
                <div className="grid md:grid-cols-2 gap-8">
                  <div>
                    ...
                    <ul className="space-y-2">
                      ...
                      <li className="flex items-center">
                        <Check className="text-green-500 w-4 h-4 mr-2" />
                        <span className="text-gray-700">Government fees</span>
                      </li>
                      <li className="flex items-center">
                        <Check className="text-green-500 w-4 h-4 mr-2" />
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Contact our experts today and start your business journey with legal recognition.
            </p>
          </div>

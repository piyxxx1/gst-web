  ...
  const features = [
    {
      icon: FileText,
      title: "Annual Filing",
      description: "Timely filing of annual returns and financial statements."
    },
    {
      icon: Shield,
      title: "Compliance Assurance",
      description: "Ensure full compliance with Companies Act requirements."
    },
    {
      icon: Calculator,
      title: "Financial Reporting",
      description: "Accurate financial reporting and documentation."
    },
    {
      icon: Lock,
      title: "Legal Protection",
      description: "Protect your company from legal complications."
    }
  ];
  ...
  const process = [
    {
      ...
      description: "Collect all required financial documents"
    },
    {
      step: "02",
      title: "Preparation",
      description: "Prepare annual returns and financial statements"
    },
    {
      step: "03",
      title: "Review & Filing",
      description: "Review and file with ROC on time"
    },
    {
      step: "04",
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-white/90 mb-8 leading-relaxed">
                Ensure timely and accurate ROC filing. Stay compliant with Companies Act requirements and avoid penalties with our expert filing services.
              </p>
            ...
            <div>
              <Card className="shadow-xl">
                <CardHeader className="text-center bg-blue-600 text-white rounded-t-lg">
                  <CardTitle className="text-2xl">ROC Filing Package</CardTitle>
                  <div className="text-4xl font-bold mt-2">₹3,999</div>
                  <p className="text-blue-100">Complete filing solution</p>
                </CardHeader>
                <CardContent className="p-6">
                  ...
                  <Button asChild className="w-full mt-6 bg-brand-amber hover:bg-amber-600 text-gray-900 font-semibold">
                    <a href="tel:+91-9471064950">Start Filing Now</a>
                  </Button>
                </CardContent>
              </Card>
            </div>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-900 mb-4">Why Choose ROC Filing?</h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Professional ROC filing services to ensure compliance and avoid penalties.
            </p>
          </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Our streamlined process ensures timely and accurate ROC filing.
            </p>
          </div>
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">

...
import { Check, Clock, Shield, FileText, Phone, Mail, MapPin, Users, Award, Palette, Lock, Globe } from "lucide-react";
  ...
  const features = [
    {
      ...
      description: "Protect your unique designs and visual creations."
    },
    {
      icon: Lock,
      title: "Exclusive Rights",
      description: "Get exclusive rights to your design for 10 years."
    },
    {
      icon: Globe,
      title: "Commercial Value",
      description: "Enhance commercial value of your designs."
    },
    {
      icon: Award,
      title: "Brand Recognition",
      description: "Build strong brand recognition and identity."
    }
  ];
  ...
  const process = [
    {
      ...
      description: "Analyze design for registration eligibility"
    },
    {
      step: "02",
      title: "Application Filing",
      description: "File design registration application"
    },
    {
      step: "03",
      title: "Examination",
      description: "Design office examination and review"
    },
    {
      step: "04",
      title: "Registration",
      description: "Receive design registration certificate"
    }
  ];
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-white/90 mb-8 leading-relaxed">
                Protect your unique designs and visual creations with comprehensive design registration. Get exclusive rights and enhance your brand value.
              </p>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-900 mb-4">Why Choose Design Registration?</h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Protect your unique designs and secure exclusive rights with our expert design registration services.
            </p>
          </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Our streamlined process ensures comprehensive design protection for your creations.
            </p>
          </div>
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <Card className="shadow-xl border-2 border-[#F7941D]">
              <CardContent className="p-8">
                <div className="text-center mb-8">
                  <h3 className="text-3xl font-bold text-gray-900 mb-4">Complete Design Registration Package</h3>
                  <div className="text-4xl font-bold text-[#F7941D] mb-2">₹6,999</div>
                  ...
                  <div>
                    ...
                    <ul className="space-y-2">
                      <li className="flex items-center">
                        ...
                        <span className="text-gray-700">Design analysis</span>
                      </li>
                      <li className="flex items-center">
                        <Check className="text-green-500 w-4 h-4 mr-2" />
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Contact our experts today and protect your unique designs with comprehensive registration.
            </p>
          </div>

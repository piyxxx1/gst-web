  ...
  const features = [
    {
      ...
      description: "Ensure accurate income tax return filing with expert guidance."
    },
    {
      icon: Shield,
      title: "Compliance Assurance",
      description: "Stay compliant with all income tax regulations and requirements."
    },
    {
      icon: TrendingUp,
      title: "Tax Optimization",
      description: "Maximize your tax deductions and minimize tax liability."
    },
    {
      icon: AlertTriangle,
      title: "Penalty Avoidance",
      description: "Avoid late filing penalties and legal complications."
    }
  ];
  ...
  const process = [
    {
      ...
      description: "Collect all income and investment documents"
    },
    {
      step: "02",
      title: "Return Preparation",
      description: "Prepare accurate income tax returns"
    },
    {
      step: "03",
      title: "Review & Filing",
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-white/90 mb-8 leading-relaxed">
                Ensure accurate and timely income tax return filing. Maximize your deductions and stay compliant with expert guidance.
              </p>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-900 mb-4">Why Choose Income Tax Filing?</h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Professional income tax filing services to ensure compliance and maximize your tax benefits.
            </p>
          </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Our streamlined process ensures timely and accurate income tax return filing.
            </p>
          </div>
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <Card className="shadow-xl border-2 border-[#F7941D]">
              <CardContent className="p-8">
                <div className="text-center mb-8">
                  <h3 className="text-3xl font-bold text-gray-900 mb-4">Complete Income Tax Filing Package</h3>
                  <div className="text-4xl font-bold text-[#F7941D] mb-2">₹1,499</div>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Contact our experts today and ensure timely income tax return filing.
            </p>
          </div>

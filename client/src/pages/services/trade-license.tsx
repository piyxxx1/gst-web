...
export default function TradeLicense() {
  ...
  const features = [
    {
      icon: Building,
      title: "Legal Business Operation",
      description: "Operate your business legally with proper licensing."
    },
    {
      icon: Shield,
      title: "Compliance Assurance",
      description: "Ensure compliance with local municipal regulations."
    },
    {
      icon: Calculator,
      title: "Business Growth",
      description: "Expand your business with proper legal foundation."
    },
    {
      icon: Lock,
      title: "Consumer Trust",
      description: "Build consumer confidence with proper licensing."
    }
  ];
  ...
  const process = [
    ...
    },
    {
      ...
      description: "Submit trade license application"
    },
    {
      step: "03",
      title: "Inspection",
      description: "Premises inspection by authorities"
    },
    {
      step: "04",
      title: "License Issuance",
      description: "Receive trade license certificate"
    }
  ];
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-white/90 mb-8 leading-relaxed">
                Get your trade license for legal business operations. Ensure compliance with municipal regulations and build consumer trust with our expert services.
              </p>
            ...
            <div>
              <Card className="shadow-xl">
                <CardHeader className="text-center bg-blue-600 text-white rounded-t-lg">
                  <CardTitle className="text-2xl">Trade License Package</CardTitle>
                  <div className="text-4xl font-bold mt-2">₹2,499</div>
                  <p className="text-blue-100">Complete licensing solution</p>
                </CardHeader>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-900 mb-4">Why Choose Trade License?</h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Essential for any business to operate legally and build consumer trust.
            </p>
          </div>

  ...
  const features = [
    {
      icon: Calculator,
      title: "Timely Filing",
      description: "Ensure timely GST return filing to avoid penalties."
    },
    {
      icon: Shield,
      title: "Compliance Assurance",
      description: "Stay compliant with all GST regulations and requirements."
    },
    {
      icon: TrendingUp,
    ...
    },
    {
      ...
      description: "Avoid late filing penalties and legal issues."
    }
  ];
  ...
  const process = [
    {
      ...
      description: "Collect all sales and purchase data"
    },
    {
      step: "02",
      title: "Return Preparation",
      description: "Prepare accurate GST returns"
    },
    {
      step: "03",
      title: "Review & Filing",
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-white/90 mb-8 leading-relaxed">
                Ensure timely and accurate GST return filing. Stay compliant and maximize your input tax credit benefits with our expert services.
              </p>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-900 mb-4">Why Choose GST Filing?</h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Professional GST filing services to ensure compliance and maximize your tax benefits.
            </p>
          </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Our streamlined process ensures timely and accurate GST return filing.
            </p>
          </div>
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <Card className="shadow-xl border-2 border-[#F7941D]">
              <CardContent className="p-8">
                <div className="text-center mb-8">
                  <h3 className="text-3xl font-bold text-gray-900 mb-4">Complete GST Filing Package</h3>
                  <div className="text-4xl font-bold text-[#F7941D] mb-2">₹1,999/month</div>
                  <p className="text-gray-600">Monthly GST filing service, no hidden charges</p>
                </div>
                  ...
                  <div>
                    ...
                    <ul className="space-y-2">
                      <li className="flex items-center">
                        ...
                        <span className="text-gray-700">GSTR-1 filing</span>
                      </li>
                      <li className="flex items-center">
                        <Check className="text-green-500 w-4 h-4 mr-2" />
                        <span className="text-gray-700">GSTR-3B filing</span>
                      </li>
                      <li className="flex items-center">
                        <Check className="text-green-500 w-4 h-4 mr-2" />
                        <span className="text-gray-700">Data reconciliation</span>
                      </li>
                      <li className="flex items-center">
                        <Check className="text-green-500 w-4 h-4 mr-2" />
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Contact our experts today and ensure timely GST return filing for your business.
            </p>
          </div>
